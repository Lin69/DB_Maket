...
{
    public partial class Metmrf : Form
    {
        public Metmrf()
        {
            InitializeComponent();
        ...
        private void Metmrf_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter SDA = new SqlDataAdapter("SELECT*From dbo.Met_M", con);
            SDA.Fill(ass, ass.Tables[0].TableName);

            ReportDataSource rds = new ReportDataSource("DataSet6", ass.Tables[0]);
