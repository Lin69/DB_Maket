...
{
    public partial class SDRF : Form
    {
        public SDRF()
        {
            InitializeComponent();
        ...
        private void SDRF_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter SDA = new SqlDataAdapter("SELECT*From dbo.S_D", con);
            SDA.Fill(ass, ass.Tables[0].TableName);

            ReportDataSource rds = new ReportDataSource("DataSet8", ass.Tables[0]);
